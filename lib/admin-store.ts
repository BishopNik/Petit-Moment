...
export type ReviewStatus = "Nowa" | "Opublikowana" | "Ukryta";
export type Review = { id: string; name: string; city: string; email?: string; text: string; rating: number; event: string; photo?: string; visible: boolean; status?: ReviewStatus; createdAt?: string; adminReply?: string; repliedAt?: string };
